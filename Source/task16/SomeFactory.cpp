...
void ASomeFactory::BeginPlay()
{
	...
	GetWorldTimerManager().SetTimer(MemberTimerHandle, this, &ASomeFactory::SpawnUnit, 0.7f, true, 2.0f);
}
...
{
	SpawnLocation = GetActorLocation() + FVector(FMath::RandRange(-800.0f, 800.0f), FMath::RandRange(-800.0f, 800.0f), 0);
